...
2. thresholded the image
3. perspective transformed a road image ('binary_warped')
4. output a binary image where lane lines stand out clearly, then

you are ready to decide explicitly which pixels are part of the lines and
which belong to the left line and
which belong to the right line.
"""

"""
Step 1 : Given you have created a warped binary image called "binary_warped",
...
"""
Step 2 : given 'binary_warped' image, find which 'hot' pixels are associated with the lane lines.
"""
...
"""
Step 2 : implement sliding windows
"""
...
"""
Step 5 : skip the sliding windows step once you know where the lines are
...
"""
Step 6 : visualise the results again

The green shaded area shows where we searched for the lines this time.
So, once you know where the lines are in one frame of video,
...
go back to your sliding windows search or
other method to rediscover them.
"""
